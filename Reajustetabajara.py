...
de salário aos seus colaboradores e lhe contraram para desenvolver o programa que calculará os reajustes.
...
Para realizar o exercício precisamos saber efetuar porcentagens 
em Python, que praticamente a mesma coisa em qualquer linguagem programa.
'''

def menu_inicial():
    print('Programa Reajuste Tabajara')
